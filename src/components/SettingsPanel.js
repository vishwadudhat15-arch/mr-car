        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                    <h2 style={{ fontSize: '32px', color: 'white', margin: 0, textShadow: '0 0 10px rgba(255,255,255,0.5)' }}>⚙️ {t.settings}</h2>
                ...
                <div style={{ background: 'rgba(0, 0, 0, 0.3)', padding: '15px', borderRadius: '15px', marginBottom: '15px', overflowY: 'auto', flex: 1 }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '15px' }}>
                        {[ { label: t.audio, key: 'audioEnabled', icon: '🔊' }, { label: t.music, key: 'musicEnabled', icon: '🎵' } ].map(s => (
